  ...
  fields: [
    {
      ...
      fields: [
        ...
        { name: 'badgeBM', type: 'text', admin: { description: 'Bahasa Malaysia. Leave blank to fall back to English.' } },
        { name: 'headlineLine1', type: 'text', defaultValue: 'Industrial' },
        { name: 'headlineLine1BM', type: 'text', admin: { description: 'Bahasa Malaysia. Leave blank to fall back to English.' } },
        { name: 'headlineLine2', type: 'text', defaultValue: 'Diamond Tools' },
        { name: 'headlineLine2BM', type: 'text', admin: { description: 'Bahasa Malaysia. Leave blank to fall back to English.' } },
        { name: 'headlineLine3', type: 'text', defaultValue: 'Built for Performance' },
        { name: 'headlineLine3BM', type: 'text', admin: { description: 'Bahasa Malaysia. Leave blank to fall back to English.' } },
        ...
        { name: 'subheadlineBM', type: 'textarea', admin: { description: 'Bahasa Malaysia. Leave blank to fall back to English.' } },
        { name: 'primaryCtaLabel', type: 'text', defaultValue: 'Explore Products' },
        { name: 'primaryCtaLabelBM', type: 'text', admin: { description: 'Bahasa Malaysia. Leave blank to fall back to English.' } },
        { name: 'secondaryCtaLabel', type: 'text', defaultValue: 'See applications' },
        { name: 'secondaryCtaLabelBM', type: 'text', admin: { description: 'Bahasa Malaysia. Leave blank to fall back to English.' } },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'statLabelBM', type: 'text', admin: { description: 'Bahasa Malaysia. Leave blank to fall back to English.' } },
      ],
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'headlineBM', type: 'text', admin: { description: 'Bahasa Malaysia. Leave blank to fall back to English.' } },
