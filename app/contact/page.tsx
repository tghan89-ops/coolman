    ...
    <PublicLayout>
      ...
      <section className="relative bg-[#0a1628] py-20 lg:py-28">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          <span className="inline-block rounded-full border border-blue-500/30 bg-blue-500/10 px-4 py-1.5 text-xs font-medium uppercase tracking-widest text-blue-400">
            Get in Touch
          </span>
          <h1 className="mt-6 font-playfair text-4xl font-bold text-white md:text-5xl lg:text-6xl">
            {t.nav.contact}
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-400">
            Have questions about our products or need a custom quote? Our team is ready to help you find the perfect solution.
          </p>
        </div>
      </section>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid gap-6 sm:grid-cols-2">
                      <div className="group space-y-2">
                        <Label htmlFor="name" className={`text-sm transition-colors ${focusedField === 'name' ? 'text-blue-400' : 'text-gray-400'}`}>
                          Name *
                        </Label>
                        <Input 
                          id="name" 
                          ...
                          className="border-white/10 bg-white/5 text-white placeholder:text-gray-500 focus:border-blue-500 focus:ring-blue-500/20"
                        />
                      </div>
                      <div className="group space-y-2">
                        <Label htmlFor="company" className={`text-sm transition-colors ${focusedField === 'company' ? 'text-blue-400' : 'text-gray-400'}`}>
                          Company
                        </Label>
                        <Input 
                          id="company" 
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="message" className={`text-sm transition-colors ${focusedField === 'message' ? 'text-blue-400' : 'text-gray-400'}`}>
                        Message *
                      </Label>
                      <Textarea 
                        id="message" 
                    ...
                    <Button 
                      type="submit" 
                      className="group w-full bg-blue-600 text-white hover:bg-blue-500" 
            ...
            <div className="space-y-6">
              ...
              {[
                ...
                },
                {
                  icon: MapPin,
                  title: 'Office',
                  content: 'No. 123, Jalan Industri 1',
                  subtitle: 'Kawasan Perindustrian Batu Caves, 68100 Selangor',
                  color: 'amber'
                }
              ].map((item, index) => (
                <div 
              ...
              <div className="rounded-xl border border-blue-500/20 bg-blue-500/5 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-blue-400">Average Response Time</span>
                </div>
                <p className="mt-2 text-3xl font-bold text-white">{"< 4 hours"}</p>
                <p className="mt-1 text-sm text-gray-400">During business hours</p>
              </div>
